def do_undo(undo_list: list, redo_list: list, current_list: list):
    ...
    :return: lista dupa ce s-a efectuat operatia de undo,current_list in caz ca nu exista functia de undo
    """
    if undo_list:
...
def do_redo(undo_list: list, redo_list: list, current_list: list):
    ...
    :param redo_list: lista de redo
    :param current_list: Lista curenta
    :return: lista dupa ce s-a efectuat operatia de redo,curent_list - in caz ca nu exista lista de redo
    """
    if redo_list:
